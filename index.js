...
async function sendTransaction(nonce) {
  ...
  // Increase the current gasPrice by a certain amount.
  ...
  const transaction = {
    to: address,
	// Replace it with the amount you want to transfer
	...
	// Limit gasLimit, based on the current network transfer settings, if you don't know how much to set go to the block browser to see how much others have transferred successfully
    gasLimit: gasLimit,
  };
